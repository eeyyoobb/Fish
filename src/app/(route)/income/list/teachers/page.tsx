...
import { Tribe, Prisma, Subject, Creator } from "@prisma/client";
...
type CreatorList = Creator & { subjects: Subject[] } & {tribes: Tribe[] };
...
<tr
  key={item.id}
 className="border-b border-gray-200 even:glass text-sm hover:bg-mayacard z-10"
>
 ...
 <td>
   <div className="flex items-center gap-2">
       <Link href={`/school/list/creators/${item.id}`}>
